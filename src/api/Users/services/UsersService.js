...
class UsersService {
  ...
  async createUser(userData) {
    ...
    return await this.usersRepository.createUser(userData, departmentIds, teamIds);
  }
  ...
  async updateUser(userData, userId) {
    ...
    if(userData.password && userData.new_password && userData.confirm_new_password){
      ...
      if(passwordsCheck){
        ...
        this.usersRepository.updateUserPassword(encryptedNewPassword, userId);
      }
    };

    userData.birth = dateConverter(userData.birth);
    
    await this.usersRepository.updateUser(userData, userId);
  };
